...
#query = """insert into personels(name, password, department, position, id) values(:name, :password, :department, :position, :id)"""
#values = {"name": "mehmet", "password": "pass1", "department": "finance", "position": "manager", "id": 3}
